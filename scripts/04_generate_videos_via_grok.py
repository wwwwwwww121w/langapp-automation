...
class GrokVideoGenerator:
    ...
    def generate_video(self, prompt: str, output_dir: str = "output/videos") -> str:
        """Генерирует видео через xAI Grok API"""
        ...
        try:
            ...
            if hasattr(response, 'url'):
                ...
                raise ValueError("Не удалось получить URL видео из ответа")

            print(f"✅ Видео сгенерировано!")
